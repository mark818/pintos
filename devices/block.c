...
/* Returns read_cnt of given block device */
unsigned long long 
block_get_read_cnt (struct block *fs_device) {
  return fs_device->read_cnt;
}

/* Returns write_cnt of given block device */
unsigned long long 
block_get_write_cnt (struct block *fs_device) {
  return fs_device->read_cnt;
}
